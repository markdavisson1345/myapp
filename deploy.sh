...
# Step 7: Copy the build files from the temporary directory to the root of gh-pages
cp -r "$TEMP_DIR"/* ./
...
echo "Deployment complete! Visit: https://markdavisson1345.github.io/myappRepo/"